...
{
    public partial class ActualHistoryDetails : System.Web.UI.Page
    {
        ActualHistoryDetailsBLL obll = new ActualHistoryDetailsBLL();
        ...
        protected void ddlDivision_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            obll.BindInitiaative(ddlInitiative, divisionid);
           // obll.BindProgressDate(ddlProgressDate, divisionid);
        }
        ...
        protected void grdvUser_RowCreated(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.Header)
                {
                    ...
                    //Adding kpi Column
                    HeaderCell = new TableCell();
                    HeaderCell.Text = "Quantitative Value";
                    HeaderCell.HorizontalAlign = HorizontalAlign.Center;
