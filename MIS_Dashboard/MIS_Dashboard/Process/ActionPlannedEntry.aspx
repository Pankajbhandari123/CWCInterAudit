<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ActionPlannedEntry.aspx.cs" Inherits="MIS_Dashboard.Process.ActionPlannedEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph" runat="server">
    ...
    <div id="divGirdShow" runat="server">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title"><b>Action Planned</b></h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel-group">
                                <asp:GridView ID="GridView1"  runat="server" ClientIDMode="Static" ShowHeaderWhenEmpty="true" EmptyDataText="No data found" AutoGenerateColumns="false" GridLines="None" HeaderStyle-Wrap="true"
                                    Width="100%" ShowFooter="true" CssClass="GridTabletrCss table table-striped table-bordered table-hover display"
                                     OnRowDataBound="GridView1_RowDataBound" OnRowCreated="GridView1_RowCreated" OnPreRender="GridView1_PreRender" >
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sl.No">
                                            <ItemTemplate>
                                                <%# Container.DataItemIndex + 1 %>
                                            </ItemTemplate>
                                            <ItemStyle Width="5px" CssClass="text-center" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Initiative">
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdnPlannedRecno" runat="server" Value='<%#Eval("PLANNED_RECNO") %>' />
                                            </ItemTemplate>
                                            <ItemStyle CssClass="text-justify" Width="200px" />
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Scheme/ program, if any" HeaderStyle-Width="10px">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Requires changes in law (Yes/No)" HeaderStyle-Width="50px">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="1-year (1 April 2019-20)">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="2-year (1 April 2020-21)">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="3-year (1 April 2021-22)">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="4-year (1 April 2022-23)">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="5-year (1 April 2022-24)">
                                            <ItemTemplate>
