<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="MIS_Dashboard.ChangePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph" runat="server">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body" runat="server" align="center">
            ...
            <div class="row" align="center">
                <div class="col-md-12">
                    <asp:Button ID="btnSave" runat="server" Text="Update" CssClass="btn btn-success" CausesValidation="false" OnClick="btnSave_Click" />
