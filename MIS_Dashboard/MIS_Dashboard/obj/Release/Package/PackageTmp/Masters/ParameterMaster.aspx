<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ParameterMaster.aspx.cs" Inherits="MIS_Dashboard.Masters.ParameterMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph" runat="server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title" align="center"><b>Parameter Master</b></h3>
    ...
    <div id="divGirdShow" class="panel panel-info" runat="server">
                <div class="panel panel-info">
                    <div class="panel-heading colorpanelhead">
                        <asp:Label ID="lblHead" runat="server" CssClass="labelPageHeader" Text="Parameter"></asp:Label>
    ...
    <div id="divEnterDetails" runat="server" visible="true">
        ...
        <div class="panel panel-info">
            <div class="panel-heading colorpanelhead">
                <asp:Label ID="Label1" runat="server" CssClass="labelPageHeader" Text="Parameter"></asp:Label>
            </div>
            ...
            <div class="panel-body">
                <div class="row ">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <div class="form-group">
                            <label class="control-label" style="font-weight: 100" for="txtRegion"><b>Parameter:</b><b class="astrik" style="color: red;">*</b></label>
                            <div class="input-group input-append  text-center">
                                <asp:TextBox ID="txtRegionName" MaxLength="100" CssClass="form-control input-sm" runat="server" required></asp:TextBox>
                            </div>
                        </div>
                    </div>
