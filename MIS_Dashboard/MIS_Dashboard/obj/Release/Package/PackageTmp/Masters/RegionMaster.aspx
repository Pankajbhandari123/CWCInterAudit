<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegionMaster.aspx.cs" Inherits="MIS_Dashboard.Masters.RegionMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph" runat="server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title" align="center"><b>Region Master</b></h3>
            ...
            <ContentTemplate>--%>
                <div class="panel panel-info">
                    <div class="panel-heading colorpanelhead">
                        <asp:Label ID="lblHead" runat="server" CssClass="labelPageHeader" Text="Region"></asp:Label>
                                    ...
                                    <asp:GridView ID="grdvUser" runat="server" OnPreRender="grdvUser_PreRender" ClientIDMode="Static" ShowHeaderWhenEmpty="true" EmptyDataText="No data found for Users" AutoGenerateColumns="False" GridLines="None" HeaderStyle-Wrap="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Region Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLoginName" runat="server" Text='<%#Eval("Region_Name") %>' />
                                                    <asp:HiddenField ID="hdnRegionRecNo" runat="server" Value='<%#Eval("Region_RECNO") %>' />
                                                </ItemTemplate>
                                                <ItemStyle CssClass="text-center" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Region Code">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEmailID" runat="server" Text='<%#Eval("Region_Code") %>' />
                                                </ItemTemplate>
                                                <ItemStyle CssClass="text-center" />
                                            </asp:TemplateField>
                ...
                <div class="row ">
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <div class="form-group">
                            <label class="control-label" style="font-weight: 100" for="txtRegion"><b>Region Name:</b><b class="astrik" style="color: red;">*</b></label>
                            <div class="input-group input-append  text-center">
                                <asp:TextBox ID="txtRegionName" MaxLength="30" CssClass="form-control input-sm" runat="server" required></asp:TextBox>
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <div class="form-group">
                            <label class="control-label" style="font-weight: 100" for="txtRegion"><b>Region Code:</b><b class="astrik" style="color: red;">*</b></label>
                            <div class="input-group input-append  text-center">
                                <asp:TextBox ID="txtRegionCode" MaxLength="30" CssClass="form-control input-sm" runat="server" required></asp:TextBox>
