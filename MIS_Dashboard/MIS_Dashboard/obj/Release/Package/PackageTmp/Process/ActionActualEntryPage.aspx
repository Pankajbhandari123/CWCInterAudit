<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ActionActualEntryPage.aspx.cs" Inherits="MIS_Dashboard.Process.ActionActualEntryPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph" runat="server">
                        ...
                        <div class="panel-group">
                            <asp:GridView ID="grdvUser" OnPreRender="grdvUser_PreRender" runat="server" ClientIDMode="Static" ShowHeaderWhenEmpty="true" EmptyDataText="No data found for Users" AutoGenerateColumns="false" GridLines="None" HeaderStyle-Wrap="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="KPI" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Divsion" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Progress Date" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRecordDate" runat="server" Text="" />
                                            <%-- Text='<%#Eval("RECORD_ENTRY_DATE") %>'--%>
                                        </ItemTemplate>
                                        <ItemStyle CssClass="text-left" />
                                    </asp:TemplateField>
    ...
    <div id="divEnterDetails" runat="server" visible="false">
        <div class="panel panel-info">
            <div class="panel-heading colorpanelhead">
                <asp:Label ID="Label1" runat="server" CssClass="labelPageHeader" Text="Action Actual"></asp:Label>
            </div>
            ...
            <div class="panel-body">
                <div class="row ">
                    ...
                    <div id="divofficetye" runat="server" visible="false">
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                ...
                                <div>
                                    <asp:DropDownList ID="ddlOfficeStatus" runat="server" CssClass="form-control input-sm" AutoPostBack="true">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <div class="form-group">
                            <label class="control-label" style="font-weight: 100;" for="ddlKpiRange"><b>KPI :</b><b class="asterik" style="color: red;">*</b></label>
                            <div>
                                <asp:DropDownList ID="ddlKpiRange" runat="server" CssClass="form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="ddlKpiRange_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ErrorMessage="Please Select Kpi" InitialValue="0" ForeColor="Red" ControlToValidate="ddlKpiRange" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel-group">
                                <asp:GridView ID="GridView1" runat="server" ClientIDMode="Static" ShowHeaderWhenEmpty="true" EmptyDataText="No data found" AutoGenerateColumns="false" GridLines="None" HeaderStyle-Wrap="true"
                                    Width="100%" ShowFooter="true" ShowHeader="false" CssClass="GridTabletrCss table table-striped table-bordered table-hover display"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Scheme/ program, if any">
                                            ...
                                            <ItemStyle Width="50px" CssClass="text-center" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Parameter (s)">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="txtParameterRemarks" runat="server" placeholder="Remarks" Text='<%#Eval("PARAMETER_REMARKS") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle CssClass="text-center" Width="100px" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="In 100 days (Planned)">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="In 100 days (Actual)">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtIn100Days" runat="server" CssClass="form-control input-sm" onkeypress="return isNumberKey(event);" OnTextChanged="txtIn100Days_TextChanged" ></asp:TextBox><br />
                                        ...
                                        <asp:TemplateField HeaderText="Completed Status">
                                            <ItemTemplate>
                                               <asp:CheckBox ID="chkCompletedStatus" runat="server" OnCheckedChanged="chkCompletedStatus_CheckedChanged" AutoPostBack="true" />
                                            </ItemTemplate>
                                            <ItemStyle CssClass="text-center" />
                                        </asp:TemplateField>
