<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UnitMaster.aspx.cs" Inherits="MIS_Dashboard.Masters.UnitMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph" runat="server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title" align="center"><b>Unit Master</b></h3>
    ...
    <div id="divGirdShow" class="panel panel-info" runat="server">
        ...
        <div class="panel-heading">
            <h3 class="panel-title"><b>Unit Details</b></h3>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel-group">
                        <asp:GridView ID="grdvUser" runat="server" OnPreRender="grdvUser_PreRender" ClientIDMode="Static" ShowHeaderWhenEmpty="true" EmptyDataText="No data found for Users" AutoGenerateColumns="False" GridLines="None" HeaderStyle-Wrap="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Sr No." HeaderStyle-CssClass="text-center" HeaderStyle-Width="20 px">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Unit Name" HeaderStyle-CssClass="text-center" HeaderStyle-Width="200px">
                                    <ItemTemplate>
                                        <asp:Label ID="lblUnitName" runat="server" Text='<%#Eval("UNIT_NAME") %>' />
                                        <asp:HiddenField ID="hdnUnitRecNo" runat="server" Value='<%#Eval("UNIT_RECNO") %>' />
                                    </ItemTemplate>
                                    <ItemStyle CssClass="text-left" />
                                </asp:TemplateField>
    ...
    <div id="divEnterDetails" runat="server" visible="false">
        ...
        <div class="panel panel-info">
            <div class="panel-heading colorpanelhead">
                <asp:Label ID="Label1" runat="server" CssClass="labelPageHeader" Text="Unit Details"></asp:Label>
            </div>
                ...
                <div class="row ">
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <div class="form-group">
                            <label class="control-label" style="font-weight: 100" for="txtRegion"><b>Unit:</b><b class="astrik" style="color: red;">*</b></label>
                            <div>
                                <asp:TextBox ID="txtUnitName" MaxLength="200" CssClass="form-control input-sm" runat="server" required></asp:TextBox>
                            </div>
                        </div>
                    </div>
