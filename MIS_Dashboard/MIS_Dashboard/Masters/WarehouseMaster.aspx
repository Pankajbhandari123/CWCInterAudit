<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WarehouseMaster.aspx.cs" Inherits="MIS_Dashboard.Masters.WarehouseMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cph" runat="server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title" align="center"><b>Warehouse Master</b></h3>
            ...
            <ContentTemplate>
                <div class="panel panel-info">
                    <div class="panel-heading colorpanelhead">
                        <asp:Label ID="lblHead" runat="server" CssClass="labelPageHeader" Text="Warehouse"></asp:Label>

                    </div>
                    <div class="pull-right" style="margin-top: -31px; height: 18px;">
                        <asp:LinkButton ID="btnAddNew" runat="server" CausesValidation="false" CssClass="btn btn-danger btn-sm" Text="Add New"></asp:LinkButton>
                    </div>
    ...
    <div id="divEnterDetails" runat="server" visible="true">

        <div class="panel panel-info">
            <div class="panel-heading colorpanelhead">
                <asp:Label ID="Label1" runat="server" CssClass="labelPageHeader" Text="Warehouse"></asp:Label>
            </div>
            ...
            <div class="panel-body">
                <div class="row ">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <div class="form-group">
                            <label class="control-label" style="font-weight: 100" for="txtRegion"><b>Warehouse Name:</b><b class="astrik" style="color: red;">*</b></label>
