...
namespace MIS_Dashboard.Masters
{
    public partial class UnitMaster : System.Web.UI.Page
    {
        ...
        UnitMasterBLL obll = new UnitMasterBLL();
        ...
        protected void lnkbtnEdit_Click(object sender, EventArgs e)
        {
            ...
            HiddenField hdnUnitRecNo = Row.FindControl("hdnUnitRecNo") as HiddenField;
            DataSet ds = obll.BindGrid(Convert.ToInt32(hdnUnitRecNo.Value));
            ViewState["UNIT_RECNO"] = Convert.ToInt32(hdnUnitRecNo.Value);
