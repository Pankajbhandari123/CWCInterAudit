...
namespace BAL
{
   public class ActionActualEntryBLL
    {
       ActionActualEntryDLL odll = new ActionActualEntryDLL();
       ...
       public DataSet GetBindGridData(int ID, string recordDate)
       {
           return odll.GetBindGridData(ID, recordDate);
       }
